...
//.pop----------------------------------
// var popped = jsonPlaceholder.pop();
// console.log(jsonPlaceholder, popped.name);


//.shift----------------------------------
// var eliminado = jsonPlaceholder.shift();
// console.log(jsonPlaceholder, eliminado.name);


//.unshift----------------------------------
// var addUsers = jsonPlaceholder.unshift("Leo Peñalver", "Fabi Tureo");
// console.log(jsonPlaceholder, addUsers.name);


//.find----------------------------------
// var found = jsonPlaceholder.find(e => e.name === "Leanne Graham");
// console.log(jsonPlaceholder, found.name);


//.some----------------------------------
// const numbersArray = [1, 2, 3, 4, 5];
// const even = (e) => e % 2 === 0;
// console.log(numbersArray.some(even)); //Output: true


//.push----------------------------------
// var pushUsers = jsonPlaceholder.push("Leo Peñalver", "Fabi Tureo");
// console.log(jsonPlaceholder, pushUsers);
...
//.indexOf----------------------------------
// var array = [2, 9, 9];
// array.indexOf(2);     // Output: 0
// array.indexOf(7);     // Output: -1
// array.indexOf(9, 2);  // Output: 2
// array.indexOf(2, -1); // Output: -1
// array.indexOf(2, -3); // Output: 0


//.slice----------------------------------
// var nombres = ['Rita', 'Pedro', 'Miguel', 'Ana', 'Vanesa'];
// var masculinos = nombres.slice(1, 3); 
// console.log(masculinos) // Output: masculinos contiene ['Pedro','Miguel']
